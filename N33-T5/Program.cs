...
class Program
{
    static void Main(string[] args)
    {
        ...
        // var UzbekCustomers = customers
        //     .Where(customer => customer.Country == Country.Uzbekistan)
        //     .ToList();
        // foreach (var customer in UzbekCustomers)
        // {
        //     Console.WriteLine($"{customer.FirstName} {customer.LastName} {customer.Country}");
        // }
        ...
        //             Console.WriteLine($"  Order ID: {customerOrder.Id}, Amount: {customerOrder.Amount}, Date: {customerOrder.OrderDate}");
        //     }
        //     else Console.WriteLine("No orders.");
        //     Console.WriteLine();
        // }
    }
